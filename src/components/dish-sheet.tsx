      ...
      <div className="space-y-6 px-6 pb-8 pt-5">
              ...
              {dish.extras.map((extra) => {
                ...
                return (
                  <button
                    ...
                    className="flex w-full items-center gap-3 bg-card px-4 py-3.5 text-left cursor-pointer active:bg-veil transition-colors"
                  >
                    <span
                      className={cn(
        ...
        <section>
          ...
          <textarea
            ...
            className="w-full resize-none rounded-2xl border border-line bg-veil px-4 py-3 text-[14.5px] font-medium placeholder:text-dim focus:outline-none focus:border-accent/50 transition-colors"
          />
        </section>
      </div>
