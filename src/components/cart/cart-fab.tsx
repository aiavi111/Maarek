      ...
      {show && (
        ...
        >
          <motion.button
            ...
            className="mb-2 flex h-[62px] w-full items-center gap-3 rounded-[26px] bg-accent px-4 text-onfg shadow-[0_18px_44px_-10px_rgba(201,162,87,0.35)] cursor-pointer"
          >
