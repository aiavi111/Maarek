    ...
    <div className="mx-5 mt-5 flex items-center gap-2.5 lg:mx-auto lg:max-w-[760px]">
      <motion.div
        animate={{
          ...
          borderColor: focused ? "rgba(201,162,87,0.55)" : "rgba(245,239,224,0.14)",
        }}
        transition={{ type: "spring", stiffness: 380, damping: 28 }}
        className="flex h-[52px] flex-1 items-center gap-2.5 rounded-full border bg-card/90 px-4 backdrop-blur-xl shadow-float"
      >
        ...
        >
          ...
          <Mic size={17} className={cn("relative", listening && "text-accent")} />
        </button>
      </motion.div>
      ...
      <motion.button
        ...
        className={cn(
          ...
          filtersActive
            ? "bg-accent text-onfg border-transparent"
            : "bg-card/90 border-line2 text-fg backdrop-blur-xl",
        )}
      >
          ...
          >
            ...
            <span
              className={cn(
                ...
                vegOnly ? "justify-end bg-accent" : "justify-start bg-fg/15",
              )}
            >
              <motion.span
                layout
